...
function runTerminal() {
  ...
  if (inp === "projects") {
    ...
    output.innerHTML +=
      "<br>help<br>Available commands: projects, interests, about, help, clear, date, time";
  } else if (inp === "clear") {
    output.innerHTML = "Ready";
  } else if (inp === "about") {
    const abStatement = `My name is Andrew Burnah.  I am a passionate computer science student studying at BYU Pathways. <br>
        I have a certificate in Software Development and Web Development and pride myself on my work ethic. <br>
        I began learning to program at age 10, and the decade since has provided me with a plethora of technical skills and abilities. <br>
        With a 3.9 GPA, I constantly strive for technical excellence and growth and try to ensure that I am always trying my best in whatever I am working at. <br> 
        My core skills for software development are with Python, JavaScript, C#, and SQL, complemented by proficiency in HTML and CSS. <br>
        Additionally, I am a fluent Spanish speaker and am eager to leverage my bilingual skills and technical expertise.`;
    write(abStatement);
  } else if (inp === "date") {
...
function doCommand(command) {
  ...
  let factor = (input, vars) => {
    if (isNaN(input[0]) && input[0] in vars) {
      ...
      while (
        args.length < functions[funcName].args.length - 1 &&
        nextarg[0] !== null
      ) {
        args.push(nextarg[0]);
